...
cc %>%
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1, face = "italic"), strip.background = element_blank(), strip.placement = "outside", 
        ...
        axis.ticks.x = element_line(), axis.title.x = element_blank(), axis.text.y = element_text(size = 9))
...
cxc %>%
  ...
  theme_bw(base_size = 12) +
  theme_jc_mult +
  theme(axis.text.x = element_text(face = "italic"), strip.background = element_blank(), strip.placement = "outside", 
        strip.text = element_text(face = "italic", colour = "black"), legend.position = "none", legend.title = element_blank(),
        axis.ticks.x = element_line(), axis.title.x = element_blank(), axis.text.y = element_text(size = 9))
...
temp %>%
  ...
  #geom_linerange(aes(x = order, ymin = 0, ymax = log(Fold_change_avg_NA))) +
  ...
  scale_color_manual(values = c("slategrey", "sienna1"), labels = c("p > 0.05", "p < 0.05")) +
  scale_size_continuous("Log(expr)") +
  coord_flip() +
  guides(colour = guide_legend(order = 1), size = guide_legend(order = 2)) +
  theme_bw(base_size = 12) +
  theme(legend.position = "right", panel.border = element_blank(), panel.grid = element_blank(), axis.line = element_line(colour = "black"), 
