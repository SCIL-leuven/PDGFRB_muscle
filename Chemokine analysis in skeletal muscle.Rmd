...
```{r}
stat <- as.data.frame(t(as.data.frame(t_data)))
stat
```
...
p %>%
  ggplot(aes(x = order, y = rev(log(Fold_change_avg_NA)), fill = as.numeric(p_value))) +
...
# TO DO
Add t-test and use significant values to colour plot